  ...
  const columns: TableProps<ITransactionType>["columns"] = [
    ...
    },
    {
      ...
      render: (text: string, record) => {
        return record?.isManual === 1 && text === "DONE" ? <Tag color="#13c2c2">MANUAL DONE</Tag> : <Tag color={text === "WAITING" ? "#2db7f5" : text === "HOLD" ? "#ad8b00" : text === "DONE" ? "#87d068" : text === "REJECT" ? "#f50" : text === "BOT FAIL" ? "#36cfc9" : ""}>{text}</Tag>;
      },
    },
    {
      title: t("staff"),
