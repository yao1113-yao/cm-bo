...
const Rekemen = ({ type }: DepositProps) => {
  ...
  return (
    <>
      ...
      <RekemenTable depositRecord={depositRecod} handleGetPendingTransactionRecord={handleGetPendingTransactionRecord} handleGetTransactionRecord={handleGetTransactionRecord} />
    </>
  );
};
