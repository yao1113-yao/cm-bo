...
const KioskErrorReport = () => {
  const { t, isLoading, userInfo, companyList, isKioskReportLoading, contextHolder, form, allGameList, apiData, initialValues, columns, handleInsertKioskError, handleGetKioskErrorReport } = useKioskErrorReport();
