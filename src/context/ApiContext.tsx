...
const ApiContext = ({ children }: IApiContextProps) => {
  ...
  const subdomain = window.location.hostname.split(".")[0] === "testcm" ? "BEST1" : window.location.hostname.split(".")[0] === "localhost" ? "BEST8" : window.location.hostname.split(".")[0].toUpperCase();
